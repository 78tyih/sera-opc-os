...
const dict: Record<string, { zh: string; en: string }> = {
  ...
  "nav.command": { zh: "指挥中心", en: "Command" },
  "nav.memory": { zh: "记忆图谱", en: "Memory Graph" },
  "nav.context": { zh: "上下文运行时", en: "Context Runtime" },
  "nav.organization": { zh: "组织系统", en: "Organization" },
  "nav.learning": { zh: "学习进化", en: "Learning" },
  "nav.layers": { zh: "智能层", en: "INTELLIGENCE LAYERS" },
  "nav.nominal": { zh: "系统正常", en: "System nominal" },
  "nav.runtimes": { zh: "所有运行时响应中", en: "All runtimes responding" },
  "nav.registry": { zh: "对象注册表", en: "Object registry" },
  "nav.settings": { zh: "系统设置", en: "System settings" },
  "nav.light": { zh: "日间模式", en: "Light mode" },
  "nav.dark": { zh: "夜间模式", en: "Dark mode" },
  "nav.language": { zh: "English", en: "中文" },
  "command.eyebrow": { zh: "系统 / 指挥中心", en: "SYSTEM / COMMAND" },
  "command.title": { zh: "Sera Intelligence", en: "Sera Intelligence" },
  "command.greeting": { zh: "早上好，Sera。公司运行正常，有一项决策需要你的授权。", en: "Good morning, Sera. Your company is operating normally. One decision needs your authority." },
  "command.graph": { zh: "智能图谱", en: "Intelligence graph" },
  "command.openGraph": { zh: "打开图谱", en: "Open graph" },
  "command.runtime": { zh: "实时运行时", en: "Live runtime" },
  "command.inspectContext": { zh: "检查 Agent 上下文", en: "Inspect agent context" },
  "command.missions": { zh: "活跃任务", en: "Active missions" },
  "command.learning": { zh: "学习流", en: "Learning stream" },
  "command.viewTimeline": { zh: "查看时间线", en: "View timeline" },
  "command.activeMissions": { zh: "活跃任务", en: "Active missions" },
  "command.agentsOnline": { zh: "在线智能体", en: "Agents online" },
  "command.pendingDecisions": { zh: "待决策事项", en: "Pending decisions" },
  "command.newLearnings": { zh: "新增学习", en: "New learnings" },
  "command.advancing": { zh: "2 项推进中", en: "2 advancing" },
  "command.executing": { zh: "4 项执行中", en: "4 executing" },
  "command.founderInput": { zh: "1 项需要创始人输入", en: "1 founder input" },
  "command.readyDistill": { zh: "准备提炼", en: "ready to distill" },
  "command.authority": { zh: "权威", en: "AUTHORITY" },
  "command.founderIntelligence": { zh: "创始人智能", en: "Founder intelligence" },
  "command.contextGovernor": { zh: "上下文治理器", en: "Context Governor" },
  "command.contextRank": { zh: "为每个智能体排序当前所需知识", en: "Ranks what each agent should know now" },
  "command.org": { zh: "组织系统", en: "ORGANIZATION" },
  "command.workflow": { zh: "工作流", en: "WORKFLOW" },
  "command.memoryOs": { zh: "记忆系统", en: "MEMORY OS" },
  "command.learningLoop": { zh: "学习闭环", en: "LEARNING LOOP" },
  "command.betterContext": { zh: "经验 → 规则 → 更好的上下文", en: "Experience → Rule → Better context" },
  "command.currentTask": { zh: "当前任务", en: "Current task" },
  "command.contextInjected": { zh: "已注入上下文", en: "Context injected" },
  "command.founderAuthority": { zh: "创始人权威", en: "Founder authority" },
  "command.knownRisk": { zh: "已知风险", en: "Known risk" },
  "command.outcomeHeader": { zh: "结果 / 负责人 / 状态 / 下一步", en: "OUTCOME / OWNER / STATE / NEXT ACTION" },
  "command.next": { zh: "下一步：", en: "Next: " },
  "command.authorityTrust": { zh: "信任优先于动效", en: "Trust > animation" },
  "command.reactRisk": { zh: "React 舞台效果曾失败", en: "React stage effect failed" },
  "command.departments": { zh: "4 个活跃部门", en: "4 active departments" },
  "command.runtimeTasks": { zh: "18 个运行时任务", en: "18 tasks in runtime" },
  "command.graphHealthy": { zh: "SMOP 图谱健康", en: "SMOP graph healthy" },
  "command.statusExecuting": { zh: "执行中", en: "EXECUTING" },
  "command.statusReview": { zh: "待审核", en: "REVIEW" },
  "command.statusLearning": { zh: "学习中", en: "LEARNING" },
...
const textDict: Record<string, string> = {
  "TradeSpan Website": "TradeSpan 网站",
  "PropFirm Video Factory": "PropFirm 视频工厂",
  "OTC Intelligence": "OTC 情报",
  "Video Producer": "视频制作智能体",
  "Validate trust hierarchy": "验证信任层级",
  "Approve real UI footage": "审核真实 UI 素材",
  "Distill client pattern": "提炼客户模式",
  "Financial UI trust rule updated": "金融 UI 信任规则已更新",
  "Video failure pattern detected": "检测到视频失败模式",
  "Founder preference resolved a conflict": "创始人偏好解决了一项冲突",
  // === Agent Names ===
  "Product Agent": "产品智能体",
  "Brand Agent": "品牌智能体",
  "UI Agent": "UI 智能体",
